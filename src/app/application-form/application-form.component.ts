...
export class ApplicationFormComponent implements OnInit {
  ...
  fBuilder = new FormBuilder().group({
    ...
    ref_first_name: null,
    ref_middle_name: null,
    ref_last_name: null,
    ref_phone: null,
    ref_email: null,
    ref_relationship: null,
  })
  ...
  onClick() {
    ...
    const { emerg_email } = this.fBuilder.controls;
    if (emerg_email.errors) {
      alert('Email for Emergency Contact is not in the right format!');
    } else if (!this.fBuilder.valid) {
